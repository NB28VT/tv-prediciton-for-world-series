class HomeController < ApplicationController
    def index
      if (params[:team1] != nil && params[:team2] != nil)
        ...
        @four_game_attendence = Team.game_attendence(@team_1, @team_2, 4)
        @five_game_attendence = Team.game_attendence(@team_1, @team_2, 5)
        @six_game_attendence = Team.game_attendence(@team_1, @team_2, 6)
        @seven_game_attendence = Team.game_attendence(@team_1, @team_2, 7)
      end
    end
end
